        ...
        <div class="tab-pane animated fadeInUpShort" id="tambah-data" role="tabpanel">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="needs-validation" action="{{route('Laporan.cetakPDF')}}" id="form" method="GET"  enctype="multipart/form-data" novalidate>

                                <input type="hidden" id="id" name="id"/>
                                <h4 id="formTitle">Laporan Kas Masuk</h4><hr>
