        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul role="tablist" class="nav nav-material nav-material-white responsive-tab">
                    <li class="nav-item">
                        <a class="nav-link active show" id="tab1" data-toggle="tab" href="#semua-data" role="tab"><i class="icon icon-home2"></i>Semua Anggota</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tab2" data-toggle="tab" href="#tambah-data" role="tab"><i class="icon icon-plus"></i>Tambah Anggota</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="needs-validation" id="form" method="POST"  enctype="multipart/form-data" novalidate>
                                    ...
                                    <h4 id="formTitle">Tambah Anggota</h4><hr>
                                    <div class="form-row form-inline">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <input type="text" name="no_hp" id="no_hp" class="form-control r-0 light s-12 col-md-6" autocomplete="off" required/>
                                            </div>
 ...
 <script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        columns: [
            ...
            {data: 'jumlah_kas', name: 'jumlah_kas'},
        ...
        $.confirm({
            ...
            buttons: {
                ok: {
                    ...
                    keys: ['enter'],
                    action: function(){
                        $.post("{{ route('Data.anggota.destroy', ':id') }}".replace(':id', id), {'_method' : 'DELETE'}, function(data) {
                           table.api().ajax.reload();
                            if(id == $('#id').val()) add();
                        }, "JSON").fail(function(){
                            reload();
