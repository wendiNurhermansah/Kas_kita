...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} | Form:Login</title>
    <!-- CSS -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-t-100">
                    <div class="text-white">
                        ...
                        <h1>KAS KITA</h1>
                        <p class="s-18 p-t-b-20 font-weight-lighter">Masukan Username dan Password Agar bisa login di Website KAS KITA</p>
                    </div>
